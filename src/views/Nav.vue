	...
	<div>
		<ul class="container">
			<div class="con-home">
				...
				<li class="b">
					<router-link to="/home"><h4>首页</h4></router-link>
				</li>
				<li class="b">
					<router-link to="/explore"><h4>发现</h4></router-link>
				</li>
				<li class="b">
					<router-link to="/question/waiting"><h4>等你来答</h4></router-link>
				</li>
				<div class="search">
					<input class="bar" type="text" placeholder="请输入您要搜索的内容..." />
					<button type="submit" class="Zi">
						<svg class="Zi--Search" fill="currentColor" viewBox="0 0 24 24">
							<path
				...
				<button class="question">提问</button>
				...
				<!-- <li class="right"><router-link to="/login">登录</router-link></li> -->
			</div>
		</ul>
		<router-view />
	</div>
